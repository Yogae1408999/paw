            ...
            <nav class="nav bd-container">
                ...
                <div class="nav__menu" id="nav-menu">
                    <ul class="nav__list">
                        ...
                        <li class="nav__item"><a href="#friend.php" class="nav__link">Friends</a></li>
            ...
            <section class="profile" id="profile">
                <div class="home__container bd-container bd-grid">
                    ...
                    <div class="profile__data">
                        ...
                        <div class="profile__grub">
                            <label>Email</label>
                            <input type="email" value="Kelompok@gmail.com" disabled>
                        </div>
                        <div class="profile__grub">
                        ...
                        <div class="profile__grub">
                            ...
                            <a href="#change_password">ubah password ?</a>
                        </div>
                        <div class="profile__grub">
